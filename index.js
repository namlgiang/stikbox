...
var leStore = require('le-store-certbot').create({
  ...
  privkeyPath: ':configDir/live/thestikbox.com/privkey.pem',          //
  fullchainPath: ':configDir/live/thestikbox.com/fullchain.pem',      // Note: both that :configDir and :hostname
  certPath: ':configDir/live/thestikbox.com/cert.pem',                //       will be templated as expected by
  chainPath: ':configDir/live/thestikbox.com/chain.pem',              //       node-letsencrypt
  workDir: '/etc/letsencrypt/var/lib',
  logsDir: '/etc/letsencrypt/var/log',
  webrootPath: '/etc/letsencrypt/srv/www/thestikbox.com/.well-known/acme-challenge',
  debug: false
});
